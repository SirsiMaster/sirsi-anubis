...
**Total ADRs: 9** | **Next available: ADR-010**
...
| ADR-010+ | Next available |

> **Last updated:** March 24, 2026 — ADR-009 accepted (Injectable Providers for 90% coverage breakthrough).
