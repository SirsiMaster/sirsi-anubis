...
"Anubis is the first infrastructure hygiene platform built for developers. 64 scan rules across 7 domains."
...
**Q: What's the moat?**
A: Rule database (64+ rules, growing), neural classification model, MCP integration with Claude/Cursor/Windsurf, and the Egyptian brand identity (Anubis = infrastructure judgment).
