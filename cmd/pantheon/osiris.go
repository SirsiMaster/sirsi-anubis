...
5-level risk assessment with time-based escalation.
  ...
  pantheon osiris assess        Show current checkpoint status
...
Risk escalates automatically:
  ...
  pantheon osiris assess             Assess current directory
  pantheon osiris assess /path/to    Assess a specific repo
  pantheon osiris assess --json      Output as JSON`,
